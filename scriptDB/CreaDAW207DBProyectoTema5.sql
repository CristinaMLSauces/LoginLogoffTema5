...
CREATE DATABASE if NOT EXISTS DAW207DBProyectoTema5;
-- Creacion de tablas de la base de datos
CREATE TABLE IF NOT EXISTS DAW207DBProyectoTema5.T02_Departamento(
...
CREATE TABLE IF NOT EXISTS DAW207DBProyectoTema5.T01_Usuario(
...
CREATE USER 'usuarioDAW207DBProyectoTema5'@'%' IDENTIFIED BY 'P@ssw0rd';
-- Permisos para la base de datos
GRANT ALL PRIVILEGES ON DAW207DBProyectoTema5.* TO 'usuarioDAW207DBProyectoTema5'@'%';